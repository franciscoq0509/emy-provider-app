...
class CustomerDetails extends React.Component {
    ...
    setDetailsState() {
        ...
        const { phoneNumbers, addresses, emergencyContacts, healthInfo, schoolInformation, allDetails, familyDoctors, authorizedPickups, unauthorizedPickups} = this.props.allCustomerDetails;
        ...
        if(primaryContact !== false && 'success' in primaryContact && primaryContact.success === true) {
            this.setState(() => ({
                allCustomerDetails: {
                    ...
                    authorizedPickups : authorizedPickups[id],
